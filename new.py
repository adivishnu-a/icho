        ...
        for face_landmarks in results.multi_face_landmarks:
            ...
            if current<-0.15 and current>-80:
                if y < -10:
                    ...
                    volume.SetChannelVolumeLevelScalar(0, (0.5 + y/100), None)  # Left
                    volume.SetChannelVolumeLevelScalar(1, (0.5 - y/100), None)  # Right
                elif y > 10:
                    ...
                    volume.SetChannelVolumeLevelScalar(0, 0.5, None)  # Left
                    volume.SetChannelVolumeLevelScalar(1, 0.5, None)  # Right
